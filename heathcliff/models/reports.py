...
from ..mutating.utils import api_post
...
def _report(campaign=None,
    ...
    if pagination is not None:
        ...
        if totalResults > itemsPerPage:
            errorString = "totalResults ({}) is greater than itemsPerPage ({})".format(totalResults, itemsPerPage)
            errorDictionary = {'log' : errorString}
            print(json.dumps(errorDictionary))
